...
object search_array(ANNkd_tree& kdtree, object qarray, int k, double eps, bool priority = false)
{
    ...
    int N = len(qarray);
    if( N == 0 ) {
        return py::make_tuple(py::empty_array(), py::empty_array());
    }
...
object k_fixed_radius_search(ANNkd_tree& kdtree, object q, double sqRad, int k, double eps)
{
    ...
    if( k <= 0 ) {
        ...
        return py::make_tuple(py::empty_array(), py::empty_array(), kball);
    }
...
object k_fixed_radius_search_array(ANNkd_tree& kdtree, object qarray, double sqRad, int k, double eps)
{
    ...
    int N = len(qarray);
    if( N == 0 ) {
        return py::make_tuple(py::empty_array(), py::empty_array(), py::empty_array());
    }
    ...
    if( k <= 0 ) {
        ...
        return py::make_tuple(py::empty_array(), py::empty_array(), py::to_array(pykball));
    }
